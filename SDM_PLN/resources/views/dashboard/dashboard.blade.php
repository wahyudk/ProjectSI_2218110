...
<title>
    Dashboard SDM PT.PLN </title>
<!--     Fonts and icons     -->
<link rel="stylesheet" type="text/css" href="https://fonts.googleapis.com/css?family=Roboto:300,400,500,700,900|Roboto+Slab:400,700" />
<!-- Nucleo Icons -->
<link href="{{asset ('Style/css/nucleo-icons.css')}}" rel="stylesheet" />
<link href="{{asset ('Style/css/nucleo-svg.css')}}" rel="stylesheet" />
<!-- Font Awesome Icons -->
<script src="{{asset ('Style/https://kit.fontawesome.com/42d5adcbca.js')}}" crossorigin="anonymous"></script>
<!-- Material Icons -->
<link href="https://fonts.googleapis.com/icon?family=Material+Icons+Round" rel="stylesheet">
<!-- CSS Files -->
<link id="pagestyle" href="{{asset ('Style/css/material-dashboard.css?v=3.1.0')}}" rel="stylesheet" />
<!-- Nepcha Analytics (nepcha.com) -->
<!-- Nepcha is a easy-to-use web analytics. No cookies and fully compliant with GDPR, CCPA and PECR. -->
<script defer data-site="YOUR_DOMAIN_HERE" src="{{asset ('Style/https://api.nepcha.com/js/nepcha-analytics.js')}}"></script>
  </head>
  ...
  <div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/material-dashboard/pages/dashboard " target="_blank">
      ...
      <span class="ms-1 font-weight-bold text-white">Dashboard PT.PLN</span>
    </a>
  </div>
...
<li class="nav-item">
  <a class="nav-link text-white " href="{{ ('post1') }}">
      <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
...
<li class="nav-item">
  <a class="nav-link text-white " href="{{ ('post3') }}">
      <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
...
<div class="row">
  ...
  <h2 class="font-weight-bolder mb-0">Manajemen SDM PT.PLN</h2>
</div>
          </div>
        </div>
      </div>
  ...
  <div class="card-header p-3 pt-2">
    ...
    <div class="text-end pt-1">
      <p class="text-sm mb-0 text-capitalize">Pegawai Libur / Izin</p>
      <h4 class="mb-0">25</h4>
    </div>
  </div>
  <hr class="dark horizontal my-0">
  ...
  <div class="card-header p-3 pt-2 bg-transparent">
    ...
    <div class="text-end pt-1">
      <p class="text-sm mb-0 text-capitalize ">Pegawai Masuk</p>
      <h4 class="mb-0 ">458</h4>
    </div>
  </div>
  ...
  <div class="card-header p-3 pt-2 bg-transparent">
    ...
    <div class="text-end pt-1">
      <p class="text-sm mb-0 text-capitalize ">Gaji</p>
...
<script src="{{asset ('Style/js/core/bootstrap.min.js')}}" ></script>
<script src="{{asset ('Style/js/plugins/perfect-scrollbar.min.js')}}" ></script>
<script src="{{asset ('Style/js/plugins/smooth-scrollbar.min.js')}}" ></script>
<script>
...
<!-- Github buttons -->
<script async defer src="{{asset ('Style/https://buttons.github.io/buttons.js"></script>
<!-- Control Center for Material Dashboard: parallax effects, scripts for the example pages etc --><script src="{{asset ('Style/js/material-dashboard.min.js?v=3.1.0"></script>
  </body>
</html>